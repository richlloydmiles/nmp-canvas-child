...
function woo_load_frontend_css () {
	wp_register_style( 'theme-stylesheet', get_stylesheet_uri(), array(), '5.8.0', 'all' );
...
function woo_custom_styling() {
	...
	foreach ( $options_init as $option ) {
		...
		if ($woo_button_color)
			$output .= 'body #wrapper #content .button, body #wrapper #content .button:visited, body #wrapper #content .reply a, body #wrapper #content #respond .form-submit input#submit, input[type=submit], body #wrapper #content button, #navigation ul.cart .button {border: none; background:'.$woo_button_color.'}' . "\n";
		if ($woo_button_hover_color)
			$output .= 'body #wrapper #content .button:hover, body #wrapper #content .reply a:hover, body #wrapper #content #respond .form-submit input#submit:hover, input[type=submit]:hover, body #wrapper #content button:hover, #navigation ul.cart .button:hover {border: none; background:'.$woo_button_hover_color.'}' . "\n";
		// Header styling
		$header_css = '';
		if ( $woo_header_bg )
